...
QList<QString> TwoAxesSettingsModel::heading = {
    "Is Active", "Axis_X", "Axis_Y", "Style", "Color", "Scatter", "Scatter Size", "Line Size"};

TwoAxesSettingsModel::TwoAxesSettingsModel(QWidget* parent = nullptr) : QTableWidget(parent) {
...
void TwoAxesSettingsModel::fillDefaultValues(const QModelIndex& parent, int start,
                                      int end) {
